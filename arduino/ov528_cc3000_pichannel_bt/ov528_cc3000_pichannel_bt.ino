...
//    BTSerial.println(alert);     //Send alert info. through BT
    ...
    sendData();                    //save picture into SD card
...
void sendData()
{
  ...
  Serial.println("Starting connection to server...");
    ...
    Serial.print(F("\n"));
    Serial.print(F("Content-Disposition: form-data;"));
    Serial.print(F(" name=\"picture\"; filename=\"CAM.JPG\""));
    Serial.print(F("\n"));
    Serial.print(F("Content-Type: image/jpeg"));
    Serial.print(F("\n"));
    Serial.print(F("Content-Transfer-Encoding: binary"));
    Serial.print(F("\n"));
    Serial.print(F("\n"));
